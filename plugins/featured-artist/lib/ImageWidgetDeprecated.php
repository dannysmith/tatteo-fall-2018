...
class ImageWidgetDeprecated {
	...
	function admin_setup() {
		...
		if ( 'widgets.php' == $pagenow ) {
			...
			wp_enqueue_script( 'image-widget', plugins_url('resources/js/image-widget.deprecated.js', dirname(__FILE__)), array('thickbox'), Image_Widget::VERSION, TRUE );
		}
		elseif ( 'media-upload.php' == $pagenow || 'async-upload.php' == $pagenow ) {
			wp_enqueue_script( 'image-widget-fix-uploader', plugins_url('resources/js/image-widget.deprecated.upload-fixer.js', dirname(__FILE__)), array('jquery'), Image_Widget::VERSION, TRUE );
