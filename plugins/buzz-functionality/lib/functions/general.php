...
{
    $studios = get_role('studio');
    $studios->add_cap('publish_guestspot');
    $studios->add_cap('edit_guestspot');
    $studios->add_cap('edit_others_guestspot');
    $studios->add_cap('delete_guestspot');
    $studios->add_cap('read_private_guestspot');
    $studios->add_cap('edit_guestspot');
    $studios->add_cap('delete_guestspot');
    $studios->add_cap('read_guestspot');
}
