	...
	<?php while (have_posts()) : the_post(); ?>
        ...
        <main id="main" class="site-main" role="main">
         <section class="edit-profile">
          ...
          <h2><?php the_title();?></h2>
          <h2><?php _e('Details', 'textdomain'); ?></h2>

				        <label for="nickname"><?php _e('Name', 'textdomain'); ?></label>
				        <input class="text-input" name="nickname" type="text" id="username" value="<?php the_author_meta( 'nickname', $current_user->ID ); ?>" />
                 
				        <label for="location"><?php _e('Current city', 'textdomain'); ?></label>
				        ...
				        <label for="date_of_birth"><?php _e('Date of birth', 'textdomain'); ?></label>
				        ...
				        <label for="instagram"><?php _e('Instagram', 'textdomain'); ?></label>
				        ...
				        <label for="description"><?php _e('Biography', 'textdomain'); ?></label>
